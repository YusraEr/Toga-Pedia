...
export function HealthIcon({ className = '', size = 20 }) {
  return (
    <svg
      width={size}
      height={size}
...
export function TeaIcon({ className = '', size = 20 }) {
  return (
    <svg
      width={size}
      height={size}
...
export function SproutIcon({ className = '', size = 20 }) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      <path d="M7 20h10" />
      <path d="M12 20v-8" />
      <path d="M12 12A5 5 0 0 1 7 7c0-2 2-3 5-3a5 5 0 0 1 5 3c0 2-2 3-5 3Z" />
    </svg>
  )
}
...
export function QRIcon({ className = '', size = 20 }) {
  return (
    <svg
      width={size}
      height={size}
